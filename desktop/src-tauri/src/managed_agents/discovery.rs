...
const HERMES_AGENT_AVATAR_URL: &str =
    "https://raw.githubusercontent.com/NousResearch/hermes-agent/main/apps/desktop/public/hermes.png";
...
const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    ...
    KnownAcpRuntime {
        ...
        commands: &["hermes-acp"],
        aliases: &[],
        avatar_url: HERMES_AGENT_AVATAR_URL,
        // Hermes intentionally scrubs messaging credentials from its native
        // terminal subprocesses. Route shell/CLI work through Buzz's trusted
        // MCP server so BUZZ_PRIVATE_KEY remains outside model-authored
        // process environments while `buzz messages send` still works.
        mcp_command: Some("buzz-dev-mcp"),
        mcp_hooks: false,
        underlying_cli: None,
        cli_install_commands: &[],
